...
class VueMygraph extends VueGenerique {
    ...
    public function vue_mygraph(){
    	?>
        <!-- Begin Page Header-->
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">My Folder Graph View</h2>
                    <div>
                        <ul class="breadcrumb">
            ...
            <div class="col-xl-12 col-md-6">
                ...
                <div class="widget widget-09 has-shadow">
                    ...
                    <div class="widget-header d-flex align-items-center">
                        <h2>You have a complete graph view of your storage below</h2>
                    </div>
                    <!-- End Widget Header -->
                    <!-- Begin Widget Body -->
        ...
        $.ajax({
            type: "POST",
            url: "./modules/mygraph/ajax_handle_mygraph.php",
            success: function(data) {
                var response = jQuery.parseJSON(data);
                var treeData = [response];

                // ************** Generate the tree diagram	 *****************
                var margin = {top: -1750, right: 120, bottom: 20, left: 120},
                    width = $('.widget-header').width() - margin.right - margin.left,
                ...
                var svg = d3.select("#jsgraph_view").append("svg")
                ...
                var panSVGZoom = svgPanZoom("#svgAffiche", {
                    zoomEnabled: true,
                ...
                panSVGZoom.zoomAtPoint(0.15, {x:50, y: 300});
